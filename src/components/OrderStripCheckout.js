...
const CheckoutForm = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { error } = await stripe.confirmPayment({
      elements,
      confirmParams: {
        return_url: `http://localhost:3000/OrderSuccess/${props.orderId}`,
      },
    });
...
export const OrderStripCheckout = (props) => {
  ...
  useEffect(() => {
    ...
    axios.post(Urls.base_url + "create-orders", formData)
      .then(res => {
...
export default OrderStripCheckout